...
-- Updating the primary owner is rejected at the privilege layer: authenticated
-- only holds column-scoped UPDATE and primary_owner_user_id is not in the list
select
    throws_ok($$
        update public.accounts
